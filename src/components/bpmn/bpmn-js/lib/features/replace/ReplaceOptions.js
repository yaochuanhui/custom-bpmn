...
export var TASK = [
	...
	},
	{
		...
		target: {
			type: 'bpmn:ServiceTask',
			serviceType: 'sendEmail'
		}
  }
  // {
	// 	label: 'tagDelegate8',
	// 	actionName: 'replace-with-test-task',
	// 	className: 'iconfont icon-gongsishiming testTag',
	// 	target: {
	// 		type: 'bpmn:ServiceTask',
	// 		serviceType: 'tagDelegate8'
	// 	}
	// },
	// {
	// 	label: 'unTagDelegate',
